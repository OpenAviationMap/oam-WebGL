...
function(Cesium,
    ...
    var OamViewer = function(options) {
        ...
        var widget = new CesiumViewerWidget({ enableDragDrop : true });

        // add drag and drop support
        var that = this;
        widget.handleDrop = function(event) {
            // enclose in a closure so that 'this' is correct when called from within the CesiumWidget
        ...
        /**
         * The a terrain provider so that we have 3D terrain
         */
        this.terrainProvider = new Cesium.CesiumTerrainProvider({ url : 'http://cesium.agi.com/smallterrain' });

        widget.centralBody.terrainProvider = this.terrainProvider;
    ...
    OamViewer.prototype.loadAirspaces = function(aixmUrls) {
        ...
        Airspace.fromAixmUrls(aixmUrls, primitives, this.terrainProvider, function(airspaces) {
    ...
    OamViewer.prototype.handleDrop = function(event) {
        ...
        for (var i = 0; i < files.length; ++i) {
            ...
            reader.onload = function(evt) {
                ...
                var airspaces = Airspace.fromAixm(aixmDoc);
                var primitives = widget.scene.getPrimitives();
...
Earth at night as seen by NASA/NOAA\'s Suomi NPP satellite.',
        ...
        providerViewModels.push(new Cesium.ImageryProviderViewModel({
            ...
            iconUrl : require.toUrl('lib/Cesium/Source/Widgets/Images/ImageryProviders/singleTile.png'),
