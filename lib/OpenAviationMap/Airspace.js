...
function(Cesium) {
    ...
    Airspace.typeToColor = {
        'P'   : new Cesium.Color(1, 0, 0, 0.4),
        'R'   : new Cesium.Color(1, 0, 0, 0.4),
        'D'   : new Cesium.Color(1, 0, 0, 0.4),
        'TRA' : new Cesium.Color(0.5, 0, 1, 0.4),
        'SA'  : new Cesium.Color(0, 0, 1, 0.4),
        'SG'  : new Cesium.Color(0, 0, 1, 0.4),
        'B'   : new Cesium.Color(0, 1, 0, 0.4)
    };
